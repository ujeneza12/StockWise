/*
  ...
  1. Problem
    ...
    - This prevents users from logging in and fetching their profile data
  ...
  3. New Policies
    ...
    - Admins can manage all profiles (simplified check)
    - Allow profile creation for new users and admins
*/
