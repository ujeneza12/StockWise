...
-- For any profiles without email, set a placeholder using phone_number if it exists
UPDATE profiles 
SET email = COALESCE(phone_number || '@placeholder.com', 'user' || id::text || '@placeholder.com')
WHERE email IS NULL;
